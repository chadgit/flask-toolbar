...
from flask_toolbar.utils import format_fname


class ProfilerToolbarPanel(ToolbarPanel):
    """
    ...
    def __init__(self, jinja_env, context={}):
        ToolbarPanel.__init__(self, jinja_env, context=context)
        if current_app.config.get('TB_PROFILER_ENABLED'):
            self.is_active = True
