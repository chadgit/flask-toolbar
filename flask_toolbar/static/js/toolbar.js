(function($) {
  ...
  $('head').append('<link rel="stylesheet" href="'+TOOLBAR_STATIC_PATH+'css/toolbar.css?'+ Math.random() +'" type="text/css" />');
  var COOKIE_NAME = 'flt';
  ...
  var flt = {
    init: function() {
      $('#flDebug').show();
      var current = null;
      $('#flToolbarPanelList li a').click(function() {
        if (!this.className) {
          return false;
        }
        ...
        if (current.is(':visible')) {
          ...
          current.show();
          $('#flToolbar li').removeClass('active');
          $(this).parent().addClass('active');
        }
        return false;
      });
      $('#flToolbarPanelList li .switch').click(function() {
      ...
      $('#flDebugTemplatePanel a.flTemplateShowContext').click(function() {
        flt.toggle_arrow($(this).children('.toggleArrow'))
        flt.toggle_content($(this).parent().next());
        return false;
      });
      $('#flDebugSQLPanel a.flSQLShowStacktrace').click(function() {
        flt.toggle_content($('.flSQLHideStacktraceDiv', $(this).parents('tr')));
        return false;
      });
      $('#flHideToolBarButton').click(function() {
        flt.hide_toolbar(true);
        return false;
      });
      ...
      $(document).bind('close.flDebug', function() {
        ...
        if ($('#flToolbar').is(':visible')) {
          flt.hide_toolbar(true);
          return;
        }
      });
      if ($.cookie(COOKIE_NAME)) {
        flt.hide_toolbar(false);
      } else {
        flt.show_toolbar(false);
      }
